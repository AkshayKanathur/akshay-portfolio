document.addEventListener('DOMContentLoaded', () => {
    ...
    // Bot Knowledge Base
    const botBrain = {
        "hello": "Greetings. How can I assist you with Akshay's portfolio?",
        "hi": "System online. Hello.",
        "skills": "Akshay specializes in SOC Operations, and Penetration Testing <br><a href='#skills' class='underline text-green-400'>Click here to see full skills</a>.",
        "experience": "He has interned at CyberSapiens (SOC Analyst intern), and Eye Q Dot Net.",
        "projects": "Key projects include Detecting nmap scans using Wazuh and Suricata, Detecting successful ssh bruteforce with Wazuh. <br><a href='#projects' class='underline text-green-400'>View Projects</a>.",
        "contact": "You can reach him at <strong>akshay.ramesha.vr@gmail.com</strong> or via LinkedIn.",
    ...
    if (textElement) {
        const roles = ["Cybersecurity Analyst", "SOC Analyst"];
